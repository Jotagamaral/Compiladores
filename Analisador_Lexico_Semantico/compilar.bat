...
java -Xmx128m -jar %JFLEX_HOME%\lib\jflex-full-%JFLEX_VERSION%.jar -d %GEN_DIR% %SRC_DIR%\exemplo.flex

echo [2/4] Gerando Analisador Sintatico (Java Cup)...
:: O -destdir joga os arquivos gerados na pasta gen
java -jar %LIB_DIR%\java-cup-11b.jar -destdir %GEN_DIR% -parser parser -symbols sym %SRC_DIR%\ex01.cup
